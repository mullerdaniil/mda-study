...
answers = [
    ...
    "направленность и сосредоточенность сознания на каком-либо предмете, явлении, деятельности",
    "процесс, посредством которого формируются образы окружающего мира, отражение реальности в психике",
    "форма психического отражения действительности, заключающаяся в закреплении и последующем воспроизведении своего опыта",
    "форма абстракции, посредством которой общие свойства конкретных примеров формулируются в виде общих понятий или утверждений",
    "человек получает знания об объекте познания косвенно, опираясь на чувственный опыт и ранее приобретённые теоретические знания",
    "познавательный процесс, с помощью которого отражается окружающая нас реальность, способ взаимодействия с внешним миром",
    "способность вызывать в сознании и произвольно сочетать образы предметов и событий"
];
